                              ...
                              <div className="p-3 d-flex flex-column flex-grow-1 justify-content-around " >
                                ...
                                <div className="mt-4">
                                  ...
                                  <div className="ProgressBarContent px-3 my-2  bg-light rounded-3">
                                    ...
                                    {/* <ProgressBar striped now={Math.floor(((Number(item.amountNow)) / Number(item.amountTRXNeed)) * 100) + 10} label={`${Math.floor(((Number(item.amountNow)) / Number(item.amountTRXNeed)) * 100)} %`} />
