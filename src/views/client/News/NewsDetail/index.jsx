                                ...
                                <div className="p-3 shadow-sm rounded-3 border bg-white ">
                                    <h2 className="fs-4 text-muted">Các tin tức khác:</h2>
                                    {
                                        newsArray
                                            ...
                                            .map((item, index) => (
                                                <div key={index} className={clsx(Style.newsItem, 'border p-2 d-flex flex-column rounded-3 mb-4 ')}>
                                                    ...
                                                    <Link to={{ pathname: '/news/' + item.id + '/' + item.friendlyUrl }} onClick={() => { window.scrollTo(0, 0) }} className={clsx(Style.linkItem, "text-decoration-none text-center  fst-italic")} >{item.title}</Link>
