...
function ClientFooter(props) {
	return (
		<div id="client-footer" className="   bg-light border-top flex-shrink-0">
				...
				<div className="row">
					<div className={clsx(Style.about, "col-12 col-md-4 px-4")}>
						...
						<p className={clsx(Style.content, "text-dark py-3")}>
							Tấm Lòng Vàng là phiên bản ứng dụng blockchain trong hoạt động từ thiện, được thành lập dựa
							trên tinh thần tương thân tương ái của người dân Việt Nam. <br />
							Website có phạm vi hoạt động toàn quốc.
						</p>
					</div>
					<div className={clsx(Style.contact, "col-12   col-md-4 px-4 ")}>
						<div className={clsx(Style.title, "fs-5 fw-bold text-uppercase w-100 py-2")}>
							Hướng dẫn - giới thiệu
						</div>
						<div className={clsx(Style.content, "text-dark py-3")}>
							<Link
								onClick={() => window.scrollTo(0, 0)}
								className="text-decoration-none text-dark text-uppercase d-block py-1"
								to="/about"
							>
								Giới thiệu
							</Link>
				...
				<div className="container py-5">
					<div className="row ">
						<div className="col-12">
							...
							<p className="m-0 text-center text-light fw-light">
								Địa chỉ: KP5, Phường Trảng Dài ,Thành phố Biên Hòa, Tỉnh Đồng Nai (DNTU)
							</p>
						</div>
					</div>
				</div>
